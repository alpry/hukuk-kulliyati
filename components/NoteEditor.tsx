    ...
    <div className="bg-white rounded-lg border border-slate-200 p-5">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xs font-semibold text-slate-800">Notlarım</h3>
        </div>
        {existingNote && icerik && (
          <button
      ...
      <textarea
        ...
        rows={5}
        className="w-full text-xs text-slate-800 border border-slate-200 rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:border-transparent resize-none placeholder:text-slate-400 transition-shadow"
      ...
      <div className="flex items-center justify-between mt-3">
        <span className="text-[10px] text-slate-400">{icerik.length} karakter</span>
        <button
          onClick={handleSave}
