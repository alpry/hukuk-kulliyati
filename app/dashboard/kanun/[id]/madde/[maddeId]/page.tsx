...
export default async function MaddePage({
  ...
  return (
    <div className="p-6 lg:p-10 max-w-3xl">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 lg:p-8 mb-5">
        <div className="flex items-center gap-3 mb-5 pb-5 border-b border-gray-100">
          <span className="text-xs font-semibold bg-blue-50 text-blue-600 px-3 py-1.5 rounded-full shrink-0">
